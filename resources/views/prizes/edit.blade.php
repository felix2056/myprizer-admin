        ...
        <div class="col-span-12 2xl:col-span-10">
            <div class="flex justify-between mb-10 items-end flex-wrap">
                <div class="page-title mb-6 sm:mb-0">
                    <h3 class="mb-0 text-[28px]">Edit Prize</h3>
                    ...
                    <form action="" method="POST" id="addPrizeForm" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-12 gap-6 mb-6">
                            <div class="col-span-12 xl:col-span-8 2xl:col-span-9 ">
                                <div class="mb-6 bg-white px-8 py-8 rounded-md">
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <input name="title" class="input w-full h-[44px] rounded-md border border-gray6 px-6 text-base  @error('title') border-red @enderror" type="text" placeholder="title" value="{{ old('title') ?? $prize->title }}">
                                        @error('title')
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <div class="min-h-[200px] @error('description') border-red @enderror" id="editor">{!! $prize->description !!}</div>
                                ...
                                <div class="bg-white px-8 py-8 rounded-md mb-6">
                                    ...
                                    <div class="grid sm:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-3 gap-x-6">
                                        <div class="mb-5">
                                            ...
                                            <input name="ticket_price" class="input w-full h-[44px] rounded-md border border-gray6 px-6 text-base @error('ticket_price') border-red @enderror" type="number" placeholder="ticket price" value="{{ old('ticket_price') ?? $prize->ticket_price }}" step="0.01">
                                            @error('ticket_price')
                                                <span class="text-red text-tiny">{{ $message }}</span>
                                            @else
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <input name="ticket_max" class="input w-full h-[44px] rounded-md border border-gray6 px-6 text-base @error('ticket_max') border-red @enderror" type="number" placeholder="ticket max entries" value="{{ old('ticket_max') ?? $prize->ticket_max }}">
                                            @error('ticket_max')
                                                <span class="text-red text-tiny">{{ $message }}</span>
                                            @else
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <input name="ticket_max_per_user" class="input w-full h-[44px] rounded-md border border-gray6 px-6 text-base @error('ticket_max_per_user') border-red @enderror" type="number" placeholder="ticket max per person" value="{{ old('ticket_max_per_user') ?? $prize->ticket_max_per_user }}">
                            ...
                            <div class="col-span-12 xl:col-span-4 2xl:col-span-3 ">
                                <div class="bg-white px-8 py-8 rounded-md mb-6">
                                    <p class="mb-2 text-base text-black">Upload Image <span class="text-red">*</span></p>
                                    <div class="text-center @error('image') border-red @enderror"">
                                        <img id="productImage-display" class="w-[100px] h-auto mx-auto" src="{{ $prize->image ?? '/images/upload.png' }}" alt="">
                                    </div>
                                    @error('image')
                                        ...
                                        <div class="category-select select-bordered">
                                            ...
                                            <select name="category_id" class="@error('category_id') border-red @enderror">
                                                @foreach (App\Models\Category::all() as $category)
                                                    <option value="{{ $category->id }}" {{ $category->id == $prize->category_id ? 'selected' : '' }}>
                                                        {{ $category->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                        ...
                        <div class="">
                            <button type="submit" class="tp-btn px-10 py-2 mb-2">Save</button>
                            <button class="tp-btn px-10 py-2 border border-[#dfdfdf] bg-transparent text-black hover:text-white hover:bg-danger hover:border-danger">Cancel</button>
                        </div>
                    </form>
                </div>
