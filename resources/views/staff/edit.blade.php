    ...
    <div class="bg-white rounded-md overflow-hidden mb-10">
        ...
        <div class="px-8 pb-8 relative">
            <div class="-mt-[75px] mb-3 relative inline-block">
                ...
                @error('photo')
                    <p class="text-red-500 text-tiny">{{ $message }}</p>
                @enderror
                
                <form id="profilePhotoForm" action="{{ route('staff.upload-photo') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input name="photo" type="file" id="profilePhoto" class="hidden">
                </form>
